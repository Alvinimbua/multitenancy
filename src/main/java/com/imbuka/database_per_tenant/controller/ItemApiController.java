...
public class ItemApiController extends AbstractBaseApiController {
    ...
    public ResponseEntity<ItemValue> createItem(@Valid @RequestBody ItemValue itemValue) {
    ...
    @PutMapping(value = "/items/{itemId}",
            consumes = {ContentType.ITEM_1_0},
            produces = {ContentType.ITEM_1_0})
    ResponseEntity<ItemValue> updateItem(@PathVariable long itemId, @Valid @RequestBody ItemValue itemValue) {
